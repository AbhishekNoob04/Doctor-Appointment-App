  ...
  return  userData &&(
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3'>
        ...
        {
        isEdit 
        ? <input className='bg-gray-100 max-w-52' value={userData.phone} onChange={(e) => setUserData(prev => ({...prev , phone:e.target.value }))} type='phone'/>
    ...
    <div>
      ...
      {
        isEdit
        ? <input className='max-w-28 bg-gray-100' value={userData.dob} onChange={(e) => setUserData(prev => ({...prev , date:e.target.value }))} type='date'/>
